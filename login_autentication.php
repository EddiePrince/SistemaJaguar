<?php
//Conecção com Banco
include 'conexao.php';//inclusão do arquio de conexão com o banco
...
//
// $sql = "insert into usuarios (nomeCompleto, email, telefone, celular, usuario, senha) values ('$nomeCompleto', '$email', '$telefone', '$celular', '$usuario', '$senha')"; //iserindo dados digitados do formulario para a tabela usuarios
