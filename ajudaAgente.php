				...
				<!-- Fim Menu -->
								...
								<div class="tab-content">
										...
										<div role="tabpanel" class="tab-pane" id="tutores"><br>
											...
											<p>
											<br><strong class="subtitulo">NATURATINS: </strong>Instituo Natureza do Tocantins.

											<br><strong class="subtitulo">U.R: </strong>Unidade Regional.

											<br><strong class="subtitulo">Banco de Dados: </strong>Banco de dados, (ou base de dados), são conjuntos de dados com uma estrutura regular que organizam informação. Um banco de dados normalmente agrupa informações utilizadas para o mesmo fim.

											<br><strong class="subtitulo">Dados: </strong>Os dados são qualquer registro ou indícios relacionáveis a alguma entidade ou evento. Por exemplo, um documento de identificação pode conter vários dados de uma pessoa com nome, sexo, data nascimento, etc.

											<br><strong class="subtitulo">E-MAIL: </strong>E-mail, correio-e, ou correi eletrônico, é um método que permite compor, enviar e receber mensagens através de sistema eletrônicos de comunicação.

											<br><strong class="subtitulo">ÍCONE: </strong>Um ícone em informática é um pequeno símbolo gráfico, usado geralmente para representar um software ou um atalho para software ou pasta.

											<br><strong class="subtitulo">USUÀRIOS: </strong>São determinados grupos de pessoas que utilizam de algum tipo de serviço, nesse caso serviço de informações, eles podem ser divididos ou classificados de acordo com uma determinada área de interesse.

											<br><strong class="subtitulo">SISTEMA: </strong>É o termo utilizado para descrever um sistema automatizado (que pode ser denominado com o Sistema de Informação Computadorizado) ou manual, que abrange pessoas, máquinas, e/ou outros métodos organizados para coletar, processar, transmitir
											e disseminar dados que representam informação para usuário.

											<br><strong class="subtitulo">INTRANET: </strong>É uma rede de computadores privativa que utiliza as mesmas tecnologias que são utilizadas na internet.

											<br><strong class="subtitulo">LINKS: </strong>LINKS: Uma hiperligação, ou simplesmente uma ligação, é uma referência num documento hipertexto a outro documento ou a outro recurso. O seu significado é “atalho”, “caminho” ou “ligação”.

											<br><strong class="subtitulo">LOGIN: </strong>É um conjunto de caracteres solicitado para os usuários que por algum motivo necessitam acessar algum sistema computacional. Geralmente os sistemas computacionais solicitam um login e uma senha para a liberação do acesso.

											<br><strong class="subtitulo">PORTAL: </strong>É um site (sítio) na internet que funciona como centro aglomerador e distribuidor de tráfego para uma série de outros sites ou subsites dentro, e também fora, do domínio ou subdomínio da empresa gestora do portal.

											<br><strong class="subtitulo">SENHA: </strong>Uma senha ou palavra-chave é uma palavra ou ação secreta previamente convencionada entre duas partes como forma de reconhecimento. Em sistema de computação, senha são amplamente utilizadas para autenticar usuários e permitir-lhes o acesso
