<?php
  ...
  $sql1 = "select * from unidades where nome like '%$filtro%' order by nome";
  $sql2 = "select * from Usuarios where nome like '%$filtro%' order by nome";
  $sql3 = "select * from animais where nome like '%$filtro%' order by nome";

  $consulta1 = mysqli_query($conexao, $sql1);

  $registros = mysqli_num_rows($consulta1); //mostrar quantos registros existem no banco
